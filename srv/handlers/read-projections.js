module.exports = (srv) => {
  srv.after('READ', 'Customers', async (customers) => {
  ...
  srv.after('READ', 'Products', async (products) => {
  ...
  srv.after('READ', 'Warehouses', async (warehouses) => {
  ...
  srv.after('READ', 'Payments', async (payments) => {
  ...
  srv.after('READ', 'Deliveries', async (deliveries) => {
